...
The checked-out code already contains the targeted daytrading BUY minimum-notional preflight, broker-authoritative position projection, bounded reconciliation, structured observability, exact schedules, cap resolution, conservative accounting, and fail-closed crypto fee/calibrated-edge gates. This is documentation/status-only: no caps, schedules, thresholds, sizing, order semantics, or trading behavior changed. No deployment or broker mutation occurred. See `CORRECTION_WORK_ITEM_2026-08-24_CONTROL-73.md`.
