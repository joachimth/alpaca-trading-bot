...
Focused Control-82 regressions and the full suite pass **213 tests / 796 assertions**; TypeScript and `git diff --check` pass. Exact validated local HEAD is `20d80ac87e08271fb0d9c1c7ea1027b72eebd48d` after committing the reliability correction. No deployment, broker mutation, migration, trigger, or external mutation was performed. Production remains **OPEN FAIL/DEGRADED** pending authenticated source-tied deployment and separate GET-only verification; see `CORRECTION_WORK_ITEM_2026-08-25_CONTROL-82.md`.
